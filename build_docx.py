...
ROWS = [
    ...
    ("Arc Pulse (бампер)", "https://arc.cc/products/arc-pulse-for-iphone-17-pro-max",
     "Алюминий 7075", "Бампер (спина открыта)", "Края / углы (до ~3 м)", "✗ (нет)", "$30–40", "€28–37", "2900–3800 ₽"),
    ("RhinoShield Mod NX (скелетон)", "https://rhinoshield.io/products/mod-nx/buy?device=iphone-17-pro-max",
     "TPU + поликарбонат", "Бампер / скелетон", "Высокая по краям (~3,3 м)", "± (модуль)", "~$32", "~€29", "~3000 ₽"),
    ("RhinoShield CrashGuard NX (бампер)", "https://rhinoshield.io/products/mod-nx/buy?device=iphone-17-pro-max",
     "TPU + поликарбонат", "Тонкий бампер", "Высокая по краям (3,5 м)", "± (модуль)", "~$25", "~€23", "~2400 ₽"),
    ("dbrand Ghost 2.0 (скелетон)", "https://dbrand.com/shop/ghost/iphone-17-pro-max-clear-cases",
     "Прозрачный полимер", "Ультратонкий", "Низкая–средняя", "✓ (18 магнитов)", "~$50", "~€46", "~4800 ₽"),
